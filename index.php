    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="location map/dakshina_kannada.html">Mangaluru</a></li>
      <li>  <a href='location map/udupi.html'>Udupi</a></li>
      <li>  <a href="location map/chikkamagaluru.html">Chikkamagaluru</a></li>
     <li>   <a href='location map/hassan.html'>Hassan</a></li>
     <li>   <a href='location map/bengaluru.html'>Bengaluru</a></li>
        </ul>
        </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="pic/q1.jpg" alt="img1" width="1200" height="700">

      </div>

      <div class="item">
        <img src="pic/q3.jpg" alt="img2" width="1200" height="700">
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Karnataka,Mangaluru<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +91 9876543210<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email:  ehealth@gmail.com<br>
      </div>
      <?php
